...
import { ImageLightbox, ImageZoomTrigger } from "../components/image-lightbox";
        ...
        >
          ...
          >
            <div className="group/preview relative overflow-hidden rounded-2xl bg-[#0d1117] shadow-xl ring-1 shadow-black/5 ring-black/10 transition-transform duration-500 hover:-translate-y-1 dark:ring-white/10">
              ...
              {/* Main Screenshot Preview with Zoom & Modal on click */}
              <div
              ...
              >
                ...
                {/* Zoom Trigger Pill */}
                <div className="absolute right-3 bottom-3 opacity-0 transition-opacity group-hover/preview:opacity-100">
                  <ImageZoomTrigger onClick={() => setIsLightboxOpen(true)} />
                </div>
                ...
                {gallery.length > 1 && (
                  <>
                    <button
                      ...
                      className="absolute top-1/2 left-2.5 flex size-8 -translate-y-1/2 cursor-pointer items-center justify-center rounded-full bg-black/60 text-white opacity-0 backdrop-blur-xs transition-opacity group-hover/preview:opacity-100 hover:bg-black/80"
                    ...
                    <button
                      ...
                      className="absolute top-1/2 right-2.5 flex size-8 -translate-y-1/2 cursor-pointer items-center justify-center rounded-full bg-black/60 text-white opacity-0 backdrop-blur-xs transition-opacity group-hover/preview:opacity-100 hover:bg-black/80"
              ...
              {project.links.live && (
                <a
                  ...
                  className={buttonVariants({
                    ...
                    size: "default",
                    className:
                      "rounded-xl px-4 text-xs font-semibold sm:text-sm",
                  })}
                >
